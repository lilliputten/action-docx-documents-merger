...
!(function (a) {
  if ('undefined' != typeof window) {
    ...
    'iframeResizer' in window ||
      ((window.iframeChildListener = function (e) {
        Ne({ data: e, sameDomian: !0 });
      }),
      R(window, 'message', Ne),
      R(window, 'readystatechange', Ae),
      Ae());
  }
  function ae() {}
  function R(e, t, n, o) {
  ...
  function se() {
    ...
    function t(e, t) {
      return (
        'function' == typeof e &&
          (k('Setup custom ' + t + 'CalcMethod'), (_[t] = e), (e = 'custom')),
        e
      );
    }
    {
      ...
      ((n = W.slice(J).split(':')),
        ...
        (M = a === n[14] ? M : n[14]),
        (v = a === n[15] ? v : e(n[15])),
        k('Initialising iFrame (' + window.location.href + ')'),
        'iFrameResizer' in window &&
          Object === window.iFrameResizer.constructor &&
          ((n = window.iFrameResizer),
          k('Reading data from page: ' + JSON.stringify(n)),
    ...
    function i(e, t) {
      (k('Add event listener: ' + t), R(window.document, e, o));
    }
    (k('TargetOrigin for parent set to: ' + T),
      le(
        'margin',
        (function (e, t) {
      ...
      k('HTML & body height set to "auto"'),
      k('Enable public methods'),
      (Q.parentIFrame = {
      ...
      (h = (function () {
        function n(e) {
          var e = e.getBoundingClientRect(),
            t = {
              x:
                window.pageXOffset === a ? document.documentElement.scrollLeft : window.pageXOffset,
        ...
        function o(e) {
          ...
          a === t
            ? (k('In page link (#' + e + ') not found in iFrame, so sending to parent'),
              F(0, 0, 'inPageLink', '#' + e))
            : ((t = n((t = t))),
              k('Moving to in page link (#' + e + ') at x: ' + t.x + ' y: ' + t.y),
        ...
        function i() {
          Array.prototype.forEach && document.querySelectorAll
            ? (k('Setting up location.hash handlers'),
              t(),
              R(window, 'hashchange', e),
              setTimeout(e, l))
            : x(
                'In page linking not fully supported in this browser! (See README.md for IE8 workaround)',
              );
        }
        h.enable ? i() : k('In page linking not enabled');
        return { findTarget: o };
      })()),
  ...
  function le(e, t) {
    a !== t &&
      '' !== t &&
      'null' !== t &&
      k('Body ' + e + ' set to "' + (document.body.style[e] = t) + '"');
  }
  function t(n) {
    var e = {
      add: function (e) {
    ...
    (n.eventNames && Array.prototype.map
      ...
      k(ue(n.method) + ' event listener: ' + n.eventType));
  }
  function fe(e) {
    (t({
      method: e,
      ...
      t({ method: e, eventType: 'Print', eventNames: ['afterprint', 'beforeprint'] }),
  ...
  function me(e, t, n, o) {
    return (
      t !== e &&
        ...
        k(o + ' calculation method set to "' + e + '"')),
      e
    );
  }
  function he() {
            ...
            : (s = (function () {
                ...
                var u = [],
                  ...
                  s = (function () {
                    ...
                    return (
                      (s = new c(a)),
                      k('Create body MutationObserver'),
                      s.observe(e, {
                        attributes: !0,
                        attributeOldValue: !1,
                        characterData: !0,
                ...
                return {
                  disconnect: function () {
                    'disconnect' in s &&
                      (k('Disconnect body MutationObserver'), s.disconnect(), u.forEach(o));
                  },
                };
              })())
          : (k('MutationObserver not supported in this browser!'), ve()))
  ...
  function we(e, t) {
    ...
    return (
      (a = Date.now() - a),
      k('Parsed ' + o + ' HTML elements'),
      k('Element position calculated in ' + a + 'ms'),
      O / 2 < (a = a) && k('Event throttle increased to ' + (O = 2 * a) + 'ms'),
      i
    );
  }
  function e(e) {
  ...
  function Ee(e, t, n, o) {
    function i() {
      e in { init: 1, interval: 1, size: 1 } || !(m in U || (d && M in U))
        ? e in { interval: 1 } || k('No change in size detected')
        : Ie(t);
    }
    function r(e, t) {
  ...
  function L(e, t, n, o) {
    i && e in j
      ? k('Trigger event cancelled: ' + e)
      : (e in { reset: 1, resetPage: 1, init: 1 } || k('Trigger event: ' + t),
        ('init' === e ? Ee : re)(e, t, n, o));
  }
  function Se() {
    (i || ((i = !0), k('Trigger event lock on')),
      clearTimeout(Y),
      (Y = setTimeout(function () {
        ((i = !1), k('Trigger event lock off'), k('--'));
      }, l)));
  }
  function Me(e) {
    ((f = C[m]()), (S = z[M]()), F(f, S, e));
  ...
  function Ie(e) {
    var t = m;
    ((m = n), k('Reset trigger event: ' + e), Se(), Me('reset'), (m = t));
  }
  function F(e, t, n, o, i) {
    !0 === V &&
      (a === i ? (i = T) : k('Message targetOrigin: ' + i),
      k(
  ...
  function Ne(t) {
    var n = {
      ...
      reset: function () {
        H ? k('Page reset ignored by init') : (k('Page size reset by host page'), Me('resetPage'));
      },
      resize: function () {
      ...
      pageInfo: function () {
        var e = i();
        (k('PageInfoFromParent called from parent: ' + e), $(JSON.parse(e)), k(' --'));
      },
      message: function () {
        var e = i();
        (k('onMessage called from parent: ' + e), G(JSON.parse(e)), k(' --'));
      },
    };
    function o() {
    ...
    y === ('' + t.data).slice(0, J) &&
      (!1 === q
        ...
        : r()
          ? n.init()
          : k('Ignored message of type "' + o() + '". Received before initialization.'));
  }
  function Ae() {
